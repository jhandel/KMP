...
class ServicePrincipalRolesTable extends BaseTable
{
    ...
    public function afterSave($event, $entity, $options): void
    {
        ...
        Cache::delete(TenantContext::cacheKey('sp_permissions_' . $servicePrincipalId), 'member_permissions');
        Cache::delete(TenantContext::cacheKey('sp_policies_' . $servicePrincipalId), 'member_permissions');
    }
