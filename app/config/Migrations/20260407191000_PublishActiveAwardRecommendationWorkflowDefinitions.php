 ...
 *
 * This ensures refreshed databases pick up the latest recommendation workflow JSON
 * and activation defaults even when earlier seed/rebuild migrations are already
 * recorded in the imported dev database snapshot.
 */
class PublishActiveAwardRecommendationWorkflowDefinitions extends BaseMigration
{
    ...
    /**
     * Publish active global workflow versions for recommendation command flows.
     *
     * @return void
     */
    ...
    /**
     * Deactivate the recommendation workflows on rollback while leaving versions in place.
     *
     * @return void
     */
