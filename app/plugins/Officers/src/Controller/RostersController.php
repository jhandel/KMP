 ...
 * Rosters Controller
 *
 * Manages officer roster generation and bulk warrant request processing.
 *
...
class RostersController extends AppController
{
    ...
    /**
     * Generate officer roster with eligibility validation.
     *
     * Displays officers organized by department with warrant eligibility checking.
     *
     * @return void
     */
    public function add()
    ...
    /**
     * Create bulk warrant requests from selected officers.
     *
     * @param \App\Services\WarrantManager\WarrantManagerInterface $warrantManager Warrant service
     * @return \Cake\Http\Response Redirects to warrant roster view
     */
