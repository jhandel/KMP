...
echo $this->KMP->getAppSetting("KMP.ShortSiteTitle") . ': Edit Workflow Transition';
$this->KMP->endBlock();
?>
...
<div class="workflowTransitions form content">
    ...
    <fieldset>
        <legend><?= $this->element('backButton') ?> <?= __('Edit Workflow Transition') ?></legend>
        <div class="mb-3">
    ...
    <div class="form-group">
        ...
        <?= $this->Form->postLink(
            ...
            [
                'confirm' => __('Are you sure you want to delete "{0}"?', $transition->name),
